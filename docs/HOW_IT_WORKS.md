# How the Catalyst Center MCP Server Works
...
└──────────┬──────────────────────────────────┬───────────┘
           ...
           ▼                                  ▼
┌─────────────────────┐           ┌───────────────────────┐
│ Catalyst Center     │           │   PostgreSQL Database │
│ catalyst-center.example.com      │           │  ┌─────────────────┐  │
│                     │           │  │ clusters        │  │
└─────────────────────┘           │  │ audit_log       │  │
                                  │  │ security_config │  │
           ▲                      │  └─────────────────┘  │
...
```bash
# Check the database
docker exec -it catc_mcp_postgres psql -U mcp_user -d catalyst_center_mcp
...
4. Fill in your Catalyst Center details
...
```bash
# In /Users/cbeye/AI/catalyst_center_mcp/.env
...
MCP Server:
  ...
  - Decrypts password ✓
  - Connects to catalyst-center.example.com ✓
  - Makes API call ✓
  - Logs to audit_log ✓
    ↓
